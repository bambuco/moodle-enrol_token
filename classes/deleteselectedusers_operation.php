...
class enrol_token_deleteselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('deleteselectedusers', 'enrol_token');
    }
    ...
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        ...
        $defaultcustomdata['message'] = get_string('confirmbulkdeleteenrolment', 'enrol_token');
        $defaultcustomdata['button'] = get_string('unenrolusers', 'enrol_token');

        return new enrol_token_deleteselectedusers_form($defaultaction, $defaultcustomdata);
    }
