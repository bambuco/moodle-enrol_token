...
if ($ADMIN->fulltree) {
    ...
    $settings->add(
        new admin_setting_configtext(
            'enrol_token/tokenlength',
            get_string('tokenlength', 'enrol_token'),
            get_string('tokenlength_help', 'enrol_token'),
            6,
            PARAM_INT
        )
    );
    ...
    $settings->add(
        new admin_setting_configselect(
            'enrol_token/status',
            get_string('status', 'enrol_token'),
            get_string('status_desc', 'enrol_token'),
    ...
    $settings->add(
        new admin_setting_configselect(
            'enrol_token/newenrols',
            get_string('newenrols', 'enrol_token'),
            get_string('newenrols_desc', 'enrol_token'),
            1,
            $options
        )
    );
    ...
    $settings->add(
        new admin_setting_configduration(
            'enrol_token/enrolperiod',
            get_string('enrolperiod', 'enrol_token'),
            get_string('enrolperiod_desc', 'enrol_token'),
            0
        )
    );
    ...
    $settings->add(
        new admin_setting_configselect(
            'enrol_token/longtimenosee',
            get_string('longtimenosee', 'enrol_token'),
            get_string('longtimenosee_help', 'enrol_token'),
            0,
            $options
        )
    );
    ...
    $settings->add(
        new admin_setting_configtext(
            'enrol_token/maxenrolled',
            get_string('maxenrolled', 'enrol_token'),
            get_string('maxenrolled_help', 'enrol_token'),
            0,
            PARAM_INT
        )
    );
    ...
    $settings->add(
        new admin_setting_configselect(
            'enrol_token/sendcoursewelcomemessage',
